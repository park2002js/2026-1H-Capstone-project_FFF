...
namespace FFF.UI.Battle
{
    ...
    public class BattleUIComponent : BaseUIComponent
    {
        ...
        public void SetupItemIcons(List<string> accessoryIds, List<string> jokerIds)
        {
            ...
            {
                foreach(var acc in accessoryIds) Instantiate(_tempAccessoryIconPrefab, _accessoryLayoutGroup, false);
                foreach(var jkr in jokerIds) Instantiate(_tempJockerIconPrefab, _jokerLayoutGroup, false);
            }
