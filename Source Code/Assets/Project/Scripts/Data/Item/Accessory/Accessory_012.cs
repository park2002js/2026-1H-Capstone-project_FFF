...
{
    /// <summary>
    /// 부여 효과: 플레이어 세륙(4-6) 족보 조합 시 최종 공격력 +5 가산.
    /// 연관: ModifierValueType.Strength, SpecificHandCondition, StrengthConstantEffect
    /// </summary>
    public class Accessory_012 : AccessoryItemBase
    {
        public override string Id => "Accessory_012";
        ...
        public override void Apply(ModifierContext context, Action onConsume = null)
        {
            ...
            _modifier = new BattleModifier(
                ...
                condition: new SpecificHandCondition(SeotdaHand.SeRyuk), 
