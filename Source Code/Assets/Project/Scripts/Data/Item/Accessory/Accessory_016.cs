...
{
    /// <summary>
    /// 부여 효과: 플레이어 알리(1-2) 족보 조합 시 최종 공격력 +5 가산.
    /// 연관: ModifierValueType.Strength, SpecificHandCondition, StrengthConstantEffect
    /// </summary>
    public class Accessory_016 : AccessoryItemBase
    {
        public override string Id => "Accessory_016";
        ...
        public override void Apply(ModifierContext context, Action onConsume = null)
        {
            ...
            _modifier = new BattleModifier(
                ...
                condition: new SpecificHandCondition(SeotdaHand.Ali), 
